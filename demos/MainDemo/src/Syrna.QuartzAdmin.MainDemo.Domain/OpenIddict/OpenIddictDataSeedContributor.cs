...
namespace Syrna.QuartzAdmin.MainDemo.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("QuartzAdmin") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor
            {
                Name = "QuartzAdmin",
                DisplayName = "QuartzAdmin API",
                Resources = { "QuartzAdmin" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //Web Client
        var webClientId = configurationSection["QuartzAdmin_Web:ClientId"];
        if (!webClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["QuartzAdmin_Web:RootUrl"]!.EnsureEndsWith('/');
        ...
        var consoleAndAngularClientId = configurationSection["QuartzAdmin_App:ClientId"];
        ...
        // Blazor Client
        var blazorClientId = configurationSection["QuartzAdmin_Blazor:ClientId"];
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["QuartzAdmin_Swagger:ClientId"];
