...
public class QuartzJobSummaryRepository
    : EfCoreRepository<QuartzAdminDbContext, QuartzJobSummary, Guid>, IQuartzJobSummaryRepository
{
    public QuartzJobSummaryRepository(IDbContextProvider<QuartzAdminDbContext> dbContextProvider)
