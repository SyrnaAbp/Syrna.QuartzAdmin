...
/// </summary>
/// <typeparam name="TChildComponent">The type of <see cref="BaseComponent"/> managed by this component.</typeparam>
public abstract class BaseItemsControl<TChildComponent> : BaseComponent
    where TChildComponent : BaseComponent
{
