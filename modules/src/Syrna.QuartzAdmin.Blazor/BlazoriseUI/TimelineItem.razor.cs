...
namespace Syrna.QuartzAdmin.Blazor.BlazoriseUI
{
    ...
    public partial class TimelineItem : BaseComponent, IDisposable
    {
        ...
        public string DotInnerClassNames => DotInnerClassBuilder.Class;
        protected ClassBuilder DotInnerClassBuilder { get; private set; }

        public string DotClassNames => DotClassBuilder.Class;
        protected ClassBuilder DotClassBuilder { get; private set; }

        public TimelineItem() : base()
        {
            DotClassBuilder = new ClassBuilder(new Action<ClassBuilder>(BuildDotClasses));
            DotInnerClassBuilder = new ClassBuilder(new Action<ClassBuilder>(BuildDotInnerClasses));
